...
with 
  | Personnage.Personnage.Personnage_mort -> raison_fin := "Vous êtes mort. Vous pouvez rejouer pour espérer faire mieux. \n\n"
  | Personnage.Personnage.Tue_En_Dormant a -> raison_fin := Monstre.Monstre.nom_monstre_tueur_nuit a^" vous a tué dans la nuit.\nC'est pour cette raison que personne ne part seul à l'aventure\n\n"
  | Personnage.Personnage.LevelMax -> raison_fin := "Votre aventure est terminée, vous êtes la personne la plus expérimentée au monde. \n(même les développeurs on dû tricher pour voir ce message)\n\n"
